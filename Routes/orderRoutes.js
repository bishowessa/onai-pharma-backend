...
router.post('/',validateOrder, checkValidationResult, userMiddleware, createOrder); // Place an order (Logged-in users)
...
router.patch('/:id', userMiddleware, updateOrderStatus); // Update order status (Admin only)
